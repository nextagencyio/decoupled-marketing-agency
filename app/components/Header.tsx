...
import { Menu, X, Briefcase, Phone, Mail, Clock } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="hidden sm:flex items-center space-x-4">
              ...
              <span className="flex items-center gap-1"><Mail className="w-3 h-3" />hello@velocitymarketing.com</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity duration-200">
              ...
              <span className="font-display text-lg font-bold text-primary-900 uppercase tracking-wide hidden sm:block">Velocity Marketing</span>
            </Link>
