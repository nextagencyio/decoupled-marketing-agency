...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Spark Creative Agency. We\'d love to hear from you about marketing strategy, brand development, or starting a project.',
  keywords: ['Contact Spark Creative Agency', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about marketing strategy, brand development, or starting a project? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@sparkcreative.agency</p>
                    <p className="text-gray-600">support@sparkcreative.agency</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 012-3425</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      700 Creative Drive, Suite 800<br />
                      Design Quarter<br />
                      New York, NY 10013
                    </p>
                  </div>
